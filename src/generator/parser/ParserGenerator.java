...
public class ParserGenerator {
    ...
    private String ifBlock(final String notTerminal) {
        ...
        for (final RuleCode subList : rulesWithCode) {
            final String afterArrow = subList.rules().get(0).Terminal();
        ...
        if (flag) {
            ...
            final List<String> l = new ArrayList<>();
            final var ll = rulesWithCode.get(0).rules();
            ...
            return String.format(CASE_BLOCK, args, h, rulesWithCode.get(0).code());
        }
